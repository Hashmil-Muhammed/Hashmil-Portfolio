  ...
  return (
    <div className={`min-h-screen font-sans bg-transparent ${darkMode ? 'dark' : ''}`}>
      ...
      <main className="relative w-full bg-transparent">
        ...
        {/* The mb-[min(100vh,1100px)] creates a transparent "hole" at the very bottom of the scrollable page to reveal the footer */}
        <div className="relative z-10 w-full bg-white dark:bg-[#0a0a0a] shadow-[0_20px_50px_rgba(0,0,0,0.5)] mb-[min(100vh,1100px)]">
        ...
        <div className="fixed bottom-0 left-0 w-full h-[min(100vh,1100px)] z-0">
