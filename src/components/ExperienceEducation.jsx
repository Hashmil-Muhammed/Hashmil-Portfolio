...
const ExperienceEducation = () => {
  ...
  const [scrollOffset, setScrollOffset] = useState(['start center', window.innerWidth < 768 ? 'end 80%' : 'end 0%']);

  useEffect(() => {
    const handleResize = () => {
      setScrollOffset(['start center', window.innerWidth < 768 ? 'end 80%' : 'end 0%']);
    };
